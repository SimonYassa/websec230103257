        ...
        <div class="col-md-8">
            <div class="card">
                ...
                <div class="card-body">
                    ...
                    <form method="POST" action="{{ route('products_update', $product->id) }}" enctype="multipart/form-data">
                        @csrf
                        @method('PUT')
                        ...
                        <div class="form-group row mb-3">
                            ...
                            <div class="col-md-6">
                                ...
                                @if($product->photo)
                                    <div class="mt-2">
                                        <img src="{{ asset('images/' . $product->photo) }}" alt="{{ $product->name }}" style="max-width: 100px;">
                                    </div>
                                @endif
                            </div>
                        </div>
                        ...
                        <div class="form-group row mb-0">
                            <div class="col-md-6 offset-md-4">
                                ...
                                <a href="{{ route('products_index') }}" class="btn btn-secondary">Cancel</a>
                            </div>
                        </div>
                    </form>
                </div>
